...
[
    ...
    // 79
    new Den("Grass", "Grass", true, [new Pokemon("Budew"),new ExclusivePair("Seedot", "Lotad"),new Pokemon("Gossifleur"),new Pokemon("Ferroseed"),new ExclusivePair("Nuzleaf", "Lombre"),new Pokemon("Applin"),new Pokemon("Roselia"),new ExclusivePair("Shiftry", "Ludicolo"),new Pokemon("Eldegoss", 1),new Pokemon("Ferrothorn", 1),new Pokemon("Roserade", 1),new ExclusivePair("Flapple", "Appletun", 1, 1, true)]),
    // 80
    ...
    // 81
    new Den("Fighting", "Ghost", true, [new ExclusivePair("Riolu", "Honedge"),new ExclusivePair("Machop", "Yamask-Galar"),new ExclusivePair("Stufful", "Sinistea"),new ExclusivePair("Farfetch'd-Galar", "Gastly"),new ExclusivePair("Bewear", "Doublade"),new ExclusivePair("Machoke", "Corsola-Galar"),new ExclusivePair("Falinks", "Haunter"),new ExclusivePair("Hawlucha", "Sableye"),new ExclusivePair("Lucario", "Polteageist", 1, 1),new ExclusivePair("Gallade", "Cursola", 1, 1),new ExclusivePair("Sirfetch'd", "Runerigus", 1, 0),new ExclusivePair("Machamp", "Gengar", 1, 0, true)]),
    // 82
...
/* templates
    ...
    // #
    new Den("", "", false, [new Pokemon("Chansey"),new Pokemon(""),new Pokemon(""),new Pokemon(""),new Pokemon(""),new Pokemon(""),new Pokemon(""),new Pokemon("", 1),new Pokemon("", 1),new Pokemon("", 1),new Pokemon("", 1),new Pokemon("", 1)]),
    // #
    new Den("", "", true, [new Pokemon("Blissey", 2),new Pokemon("", 2),new Pokemon("", 2),new Pokemon("", 2),new Pokemon("", 2),new Pokemon("", 2),new Pokemon("", 2),new Pokemon("", 2),new Pokemon("", 2),new Pokemon("", 2),new Pokemon("", 2),new Pokemon("", 2)]),
*/
